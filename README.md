...
cgit commit: `8c91cbcb8dd5c12ef24b5f35e4fdcc3780568d90`
gogit commit: TBD

- [x] cache.h ==> folded in to read-cache.go
- [x] commit-tree.c ==> commit-tree.go
- [x] cat-file.c ==> cat-file.go
- [x] init-db.c ==> init-db.go
- [x] MAKEFILE ==> magefile.go
- [-] read-cache.c ==> read-cache.go
- [ ] read-tree.c ==> read-tree.go
- [ ] show-diff.c ==> show-diff.go
- [ ] update-cache.c ==> update-cache.go
- [ ] write-tree.c ==> write-tree.go

# Original Torvalds README
